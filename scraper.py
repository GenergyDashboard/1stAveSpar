        ...
        try:
            if use_auth_state:
                ...
                page.goto("https://www.soliscloud.com/station",
                          ...
                          timeout=90000)
                # Wait for the page to settle instead of relying on networkidle,
                # which times out because SolisCloud keeps background requests alive.
                try:
                    page.wait_for_load_state("load", timeout=30000)
                except Exception:
                    pass  # DOM is ready; background activity doesn't matter
                human_delay(4, 7)
            ...
            if not use_auth_state:
                ...
                try:
                    ...
                    pass  # Page is ready; ignore lingering background requests
                human_delay(7, 10)
            ...
            try:
                ...
                pass  # Popup DOM ready; background activity can continue
